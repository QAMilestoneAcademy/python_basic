# s = input("Enter the name of any movie with more than 2 one words:-")
...
# print("String in capital",s.capitalize())
# # # # Convert to a title
# print("string in title form",s.title())
# print(s.upper())
# #
# # movie_1="Mission Impossible"
# # s1=s.title()
# #
# # #
# # # reverse the name
...
# # my_num=input("Enter numbers separated by ,")
s = input("Enter the list of fruits separated by comma")
